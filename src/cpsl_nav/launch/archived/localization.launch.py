...
def launch_setup(context, *args, **kwargs):
    ...
    if (scan_topic_str and not scan_topic_str.startswith('/')):
        scan_topic_str = '/' + scan_topic_str
    ...
    localization = GroupAction([
        ...
        SetRemap('/cpsl_ugv_1/tf','/tf'),
        # SetRemap('/tf_static', namespace_str + '/tf_static'),
        # SetRemap(namespace_str + '/scan', namespace_str + scan_topic_str),
        SetRemap('scan',f"{namespace_str}{scan_topic_str}"),
        SetRemap('initialpose','/initialpose'),
